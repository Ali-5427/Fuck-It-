...
- All features can be tested using the provided demo account credentials.
- Sandbox in-app purchases are enabled for testing.
- Sign in with Apple is implemented for seamless authentication.
- Privacy Policy: ${inspection.metadata.privacyPolicyUrl || 'https://yourdomain.com/privacy'}
- Support URL: ${inspection.metadata.supportUrl || 'https://yourdomain.com/support'}`;
}
